    ...
    public static void main(String[] args)throws Exception{
        ...
        if(args.length != 1){
            ...
            */
            ...
            FileOutputStream out = new FileOutputStream("cifrado"+args[0]);
            ...
            + "en el archivo: " +"descifrado"+args[0]);
            ...
            in = new FileInputStream("cifrado"+args[0]);
            out = new FileOutputStream("descifrado"+args[0]);
